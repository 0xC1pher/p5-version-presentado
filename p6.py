...
def select_modulation():
    ...
    while True:
        ...
        if choice in ["1", "2", "3"]:
            return {"1": "qpsk", "2": "16qam", "3": "64qam"}[choice]
        else:
...
def get_bandwidth_and_spacing():
    ...
    while True:
        try:
            ...
            delta_f = float(input("Ingrese el espaciado entre subportadoras (Hz) (15KHz o 7.5KHz): "))
            if delta_f in [15000, 7500]:
                return bw, delta_f
            else:
                print("El espaciado entre subportadoras debe ser 15KHz o 7.5KHz. Intente nuevamente.")
        except ValueError:
    ...
    while True:
        try:
            ...
            if snr_dB >= 0:
                ...
                print("El valor de SNR debe ser mayor o igual a 0. Intente nuevamente.")
        except ValueError:
            print("Entrada no válida. Ingrese un número.")

def get_longitud_CP(delta_f):
    """
    ...
    Returns:
        int: Longitud del prefijo cíclico.
    """
    while True:
        try:
            choice = int(input("Escoger Prefijo cíclico: 1. Normal 2. Extendido: "))
            if choice == 1:
                return 4.6e-6  # 4.6 µs
            elif choice == 2:
                if delta_f == 15000:
                    return 16.6e-6  # 16.6 µs
                else:
                    return 33e-6  # 33 µs
            else:
                print("Opción no válida. Intente nuevamente.")
...
def main():
    ...
    n = calculate_ifft_size(nc)  # Tamaño de la IFFT
